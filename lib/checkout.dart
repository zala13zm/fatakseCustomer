...
import 'package:zomatoui/payment_page.dart';
...
bool _onlinePaymentSelected = false;
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsets.only(bottom: 5, left: 16, right: 2, top: 2),
                    child: InkWell(
                      child: Icon(
                  ...
                  Padding(
                    padding:
                        EdgeInsets.only(bottom: 5, left: 6, right: 2, top: 2),
                    child: Text(
                      'Delivery at ',
              ...
              Row(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsets.only(bottom: 5, left: 7, right: 16, top: 2),
                    child: Text(
                      'Delivery in ',
                      textAlign: TextAlign.start,
                      style: TextStyle(
